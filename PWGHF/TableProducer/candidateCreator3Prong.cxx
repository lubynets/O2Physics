...
struct HfCandidateCreator3Prong {
  ...
  void init(InitContext const&)
  {
    ...
    registry.add("hMass3PKPi", "3-prong candidates;inv. mass (p K#pi) (GeV/#it{c}^{2});entries", {HistType::kTH1F, {{600, 1.9, 2.5}}});
    registry.add("hMass3PiKP", "3-prong candidates;inv. mass (#pi Kp) (GeV/#it{c}^{2});entries", {HistType::kTH1F, {{600, 1.9, 2.5}}});
